...
type: micro
brief:
  system: mystic-bytes essay corpus — 92 markdown files with placeholder briefs
  issue: rewrite urge hit before anyone mapped what the legacy files actually do
  constraint: no greenfield generator; preserve slugs, numbers, and frontmatter keys
---
